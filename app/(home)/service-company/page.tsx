    ...
    return (
        <div className="flex flex-col bg-[#FFFFFF]">
            ...
            <div className='flex flex-col gap-[10px] px-[10px] md:px-[50px] lg:px-[100px] py-4 '>
                <span className='text-[16px] font-[600] text-black'>Available Company For home cleaning</span>
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            {services.map((service: any, index: number) => {
                                return (
                                    <a href='./book-service/1234' className='flex flex-col gap-[10px]'>
                                        <div key={index} className='flex relative cursor-pointer hover:opacity-70 overflow-hidden duration-300 flex-col justify-between p-4 rounded-[24px] bg-[#F6F6F6] h-[20vh]'>
                                        ...
                                        <div className='flex flex-row gap-[10px]  justify-between'>
                                            <div className='flex flex-row items-center gap-[10px]'>
                                                <div className='w-[35px] h-[35px] rounded-full'>
                                                    <Image src={`/image/company.png`} width={1000} height={1000} alt='' className='w-full h-full rounded-full object-cover' />
                                                </div>
                                                <div className='flex flex-col gap-[2px]'>
                                                    <h1>Supreme Shine Cleaners</h1>
                                                    <div className='flex flex-row items-center gap-[10px]'>
