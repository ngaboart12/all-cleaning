            ...
            <div className='bg-white flex flex-row rounded-[30px] max-h-[90%] w-[95%] sm:w-[70%] md:w-[95%] lg:w-[70%] overflow-hidden'>
                <div className='w-full md:w-1/2 h-full flex flex-col gap-[4px] p-5 py-10 lg:p-10'>
                    <div className='w-[60px]'>
                        <Image src={`/image/swifti.svg`} width={1000} height={1000} className='w-full' alt='logo swifti' />
                    </div>
                    ...
                    <form onSubmit={CredentialsFormik.handleSubmit} className='flex flex-col gap-[10px] py-4'>
                        ...
                        {CredentialsFormik.touched.email && CredentialsFormik.errors.email ? (
                            <div className='text-red-500 text-[12px] px-4'>{CredentialsFormik.errors.email}</div>
                        ) : null}
                        ...
                        {CredentialsFormik.touched.password && CredentialsFormik.errors.password ? (
                            <div className='text-red-500 text-[12px] px-4'>{CredentialsFormik.errors.password}</div>
                        ) : null}
                        ...
                        <div className='flex flex-col gap-[4px]'>
                            <button type='submit' className='w-full flex items-center justify-center h-[50px] rounded-[24px] bg-[#1990AF] text-white'>
                                {loading ? (<ReactLoading type='bubbles' color='#fff' width={24} height={24} />) : "Sign In"}
                            </button>
                            <span className='text-center'>OR</span>
                            <button type='button' className='w-full h-[50px] rounded-[24px] border-[1.4px] border-[#1990AF]/50 text-[#1990AF]'>Sign in with Google</button>
                        </div>
                    </form>
                </div>
                <div className='hidden w-1/2 bg-[#1990AF] md:flex flex-col items-center gap-[20px] relative'>
                    <div className='w-full h-full absolute z-10'>
                        <Image src={`/image/background.svg`} className='w-full h-full object-cover' width={1000} height={1000} alt='background' />
                    </div>
                    ...
                    <div className='w-full relative z-20 mt-[-30px]'>
                        <Image alt='decorative' src={`/image/authback.png`} width={1000} height={1000} className='w-full h-full' />
                    </div>
                </div>
            </div>
        </div>
