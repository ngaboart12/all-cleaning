...
import MessageTo from '@/components/booking/MessageTo'
...
const BookService = () => {
    ...
    return (
        <div className='w-full  bg-[#FAFAFA] py-20 px-[10px] md:px-[50px] lg:px-[150px] flex flex-col gap-[20px]'>
                    ...
                    <>
                        ...
                        <div className='w-full md:w-1/3  bg-white rounded-[12px] p-4 flex flex-col gap-[20px]'>
                            <div className='w-full h-[25vh]'>
                                <Image src={'/image/loudry.png'} width={1000} height={1000} alt='service image' className=' w-full h-full object-cover rounded-[6px]' />
                            </div>
                            <div className='flex flex-row gap-[10px] items-center'>
                                <div className='w-[50px] h-[50px]'>
                                    <Image src={'/image/user1.jpg'} width={1000} height={1000} alt='service image' className=' w-fulll h-full object-cover rounded-[6px]' />
                            ...
                            <div className='flex flex-col gap-[10px] '>
                                <h2 className='text-[14px] text-[#9D9D9D]'>About</h2>
                                <span className='text-[14px] text-[#3B3B3B] font-[400]'>Share pencil connection draft text. Main stroke ellipse team frame layer pixel outline scale link. Font boolean list mask distribute.</span>
                            </div>

                        </div>
                        {steps === 1 && (<SelectType setSteps={setSteps} />)}
                        {steps === 2 && (<ServiceDetailsForm setSteps={setSteps} />)}
                        {steps === 3 && (<MessageTo setSteps={setSteps} />)}
