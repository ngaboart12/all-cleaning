...
const ProvidersContent = () => {
  ...
  const serviceName = searchParams.get('serviceName') || 'Services';
        ...
        <div className='flex flex-row justify-between items-center'>
          <div className='flex flex-row gap-[20px] items-center'>
            ...
            <div className='rounded-[6px] bg-white p-2'>
              <span className='text-[12px] font-[600]'>{providers.length}</span>
            </div>
          </div>
          <div className='p-1 px-4 rounded-[42px] bg-white flex flex-row gap-[10px] items-center'>
            <div>
              <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 17.5L22.5 22" stroke="#7C7C7C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M20.5 11C20.5 6.02944 16.4706 2 11.5 2C6.52944 2 2.5 6.02944 2.5 11C2.5 15.9706 6.52944 20 11.5 20C16.4706 20 20.5 15.9706 20.5 11Z" stroke="#7C7C7C" strokeWidth="1.5" strokeLinejoin="round" />
              </svg>
            </div>
        ...
        <div className='grid grid-cols-3 gap-[20px]'>
          {providers.map((item: any, index: number) => (
            <div key={index} className='w-full'>
              <div className='cursor-pointer provider p-4 bg-white rounded-[12px] flex flex-col gap-[10px]'>
