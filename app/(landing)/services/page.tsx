        ...
        <div className='w-full flex flex-col relative bg-[#FAFAFA] '>
            ...
            <div className='px-[20px] md:px-10 lg:px-20 items-center justify-center  w-full bg-white flex flex-col gap-[40px]'>
                {serviceData.services.map((item: any, index: number) => {
                    return (
                        <div key={index} id={item.slug} className={`flex flex-col ${index % 2 !== 0 ? "lg:flex-row-reverse" : "lg:flex-row"} lg:flex-row w-full gap-[20px] items-center py-20`}>
                            <div className='w-full lg:w-1/2 flex flex-col gap-[10px]'>
                                <h1 className='text-[22px] font-[600] text-primary'>{item.name}</h1>
                                <span className='text-[14px] text-[#5F5F5F]'>{item.description}</span>
                            ...
                            <div className='w-full lg:w-1/2 flex flex-col'>
                                <div className='flex w-full items-center justify-center flex-row gap-[10px]'>
                                    <div className='relative'>
                                        ...
                                        <Image src="/image/homeclean.png" className='w-full rounded-[24px]' alt='back' width={200} height={200} />
                                    </div>
                                    <div>
                                        <Image src="/image/movein.png" className='w-full rounded-[24px]' alt='back' width={200} height={200} />
                                    </div>
                                </div>
                            </div>
