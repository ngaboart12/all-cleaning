            ...
            <div className=' flex flex-col lg:flex-row gap-[20px]  w-full'>
                <div className='w-full lg:w-[70%] flex flex-col gap-[10px]'>
                    <div className='w-full p-6 flex flex-col gap-[4px] bg-[#F6F6F6] rounded-[12px]'>
                        ...
                        <div className='flex flex-row gap-[10px]'>
                            <span className='text-[14px] font-[400] text-[#868686]'>{currentDate.toLocaleDateString()}</span>
                        </div>
                        <div className='w-full flex flex-row rounded-[12px] p-2 fle  gap-[10px] '>
                            <div className='w-full p-2 bg-[#FFFFFF] rounded-[12px] flex flex-row items-center gap-[10px]'>
                                ...
                                <input type="text" className='w-full h-full bg-transparent outline-none text-[#9D9D9D] placeholder:text-[#9D9D9D] text-[12px]' placeholder='Search provider' />
                            </div>
                            <div className=' px-4 items-center p-2 bg-white rounded-[12px] flex flex-row  gap-[10px]'>
                                <div><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.9163 9.16667C12.9163 10.7775 11.6105 12.0833 9.99967 12.0833C8.38884 12.0833 7.08301 10.7775 7.08301 9.16667C7.08301 7.55583 8.38884 6.25 9.99967 6.25C11.6105 6.25 12.9163 7.55583 12.9163 9.16667Z" stroke="black" stroke-width="1.5" />
                                    <path d="M10 1.66666C14.0588 1.66666 17.5 5.02747 17.5 9.10482C17.5 13.2471 14.0027 16.1539 10.7725 18.1306C10.5371 18.2635 10.2708 18.3333 10 18.3333C9.72917 18.3333 9.46292 18.2635 9.2275 18.1306C6.00325 16.1347 2.5 13.2614 2.5 9.10482C2.5 5.02747 5.9412 1.66666 10 1.66666Z" stroke="black" stroke-width="1.5" />
                                </svg>
                                </div>
                                <span className='text-[14px] font-[400] text-[#000000]'>Location</span>

                            </div>
                        </div>
                        <div className='flex flex-col gap-[4px]'>
                            <h1 className='text-[14px] text-black font-[500]'>Recommended Services</h1>
                                        ...
                                        {baseService?.map((base: any, index: number) => {
                                            return (
                                                <div className='p-3 cursor-pointer flex flex-row gap-[3px] justify-center items-center bg-[white] rounded-[12px]'>
                                                    ...
                                                    <span className='text-[12px] text-black '>{base.title} </span>
                                                </div>
                    ...
                    <div className='w-full pb-4  bg-white rounded-[12px]'>
                        <div className='flex flex-row gap-[4px] sm:gap-[20px] items-center'>
                            <div onClick={() => setCurrentOpen(1)} className={` cursor-pointer flex flex-row items-center  p-2 sm:p-4 ${currentOpen == 1 ? " border-b-[2px] border-primary" : ""} gap-[10px]`}>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.10638 1.66667C5.38872 1.66667 4.02988 1.66667 3.08622 2.33154C2.81584 2.52203 2.57581 2.74794 2.37341 3.00241C1.66699 3.89056 1.66699 5.16947 1.66699 7.72728V9.8485C1.66699 12.3178 1.66699 13.5524 2.05778 14.5385C2.686 16.1238 4.01461 17.3743 5.69896 17.9655C6.74668 18.3333 8.0585 18.3333 10.6822 18.3333C12.1814 18.3333 12.931 18.3333 13.5297 18.1232C14.4922 17.7853 15.2513 17.0708 15.6103 16.1649C15.8337 15.6014 15.8337 14.8959 15.8337 13.4848V12.9167" stroke={` ${currentOpen == 1 ? "#13829F" : "#8D8D8D"}`} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12.5 6.24999C12.5 6.24999 12.9167 6.24999 13.3333 7.08333C13.3333 7.08333 14.6568 4.99999 15.8333 4.58333" stroke={` ${currentOpen == 1 ? "#13829F" : "#8D8D8D"}`} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div onClick={() => setCurrentOpen(2)} className={` cursor-pointer flex flex-row items-center  p-2 sm:p-4 ${currentOpen == 2 ? " border-b-[2px] border-primary" : ""} gap-[10px]`}>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.0003 18.3333V15M6.66699 16.6667V15M13.3337 16.6667V15" stroke={` ${currentOpen == 2 ? "#13829F" : "#8D8D8D"}`} stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M15.8337 14.5833C16.4791 14.4451 16.966 14.2143 17.3573 13.8291C18.3337 12.8682 18.3337 11.3216 18.3337 8.22836C18.3337 5.13515 18.3337 3.58855 17.3573 2.62761C16.3811 1.66667 14.8097 1.66667 11.667 1.66667H8.33366C5.19096 1.66667 3.61962 1.66667 2.6433 2.62761C1.66699 3.58855 1.66699 5.13515 1.66699 8.22836C1.66699 11.3216 1.66699 12.8682 2.6433 13.8291C3.03464 14.2143 3.52158 14.4451 4.16699 14.5833" stroke={` ${currentOpen == 2 ? "#13829F" : "#8D8D8D"}`} stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M15.4167 8.33333H15.4092" stroke={` ${currentOpen == 2 ? "#13829F" : "#8D8D8D"}`} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M4.59147 8.33333H4.58398" stroke={` ${currentOpen == 2 ? "#13829F" : "#8D8D8D"}`} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div className='flex w-full lg:w-[30%] flex-col md:flex-row lg:flex-col  gap-[10px] '>
                    ...
                    <div className=' w-full flex flex-col gap-[10px]'>
                        ...
                        <a href='#' className=' p-4 duration-200 transition-all hover:bg-[#f8f8f8] bg-white rounded-[12px] flex flex-row gap-[10px] items-center'>
                            <div className='w-[60px]'>
                                <Image src={`/image/Wallet.svg`} width={1000} height={1000} alt='wallet svg' className='w-full' />
                            </div>
                            <div className='flex flex-col gap-[4px]'>
                                <h1 className='text-[14px] text-[#13829F] font-[600]'>PAYMENTS</h1>
                                <span className='text-[12px] font-[600] text-[#000000]'>Anything you want  to know a about payment</span>
                            </div>
                        </a>
                        <a href='#' className=' p-4 duration-200 transition-all hover:bg-[#f8f8f8] bg-white rounded-[12px] flex flex-row gap-[10px] items-center'>
                            <div className='w-[60px]'>
                        ...
                        <div className=' bg-white  p-4 rounded-[12px] flex flex-row gap-[10px] justify-between items-center'>
                            <a href="#" className='text-[13px] text-[#606060] hover:text-[#000000]'>About</a>
                            <a href="#" className='text-[13px] text-[#606060] hover:text-[#000000]'>Help</a>
                            <a href="#" className='text-[13px] text-[#606060] hover:text-[#000000]'>Terms</a>
                            <a href="#" className='text-[13px] text-[#606060] hover:text-[#000000]'>Language</a>
                        </div>
