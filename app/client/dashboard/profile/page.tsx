            ...
            {!isLoading ? (<>
                ...
                <div className='w-full flex flex-row justify-between items-center '>
                    <div className='flex flex-col '>
                        ...
                        <span className='text-[14px] font-[400] text-black/40'>{profile?.name}</span>
                    </div>
                    ...
                    <div className='w-1/3 bg-white p-4 flex flex-col gap-[20px]'>
                        <div className='flex flex-row gap-[10px] items-center'>
                            ...
                            <div className='flex flex-col gap-[4px]'>
                                <span className='text-[14px] font-[600] text-black'>{profile?.name}</span>
                                <span className='text-[14px] font-[400] text-black/40'>{profile?.email}</span>
                            </div>
                        </div>
                                            ...
                                            {profile?.Property?.map((por:any,index:number)=>{
                                                return(
                                                    ...
                                                    <div className='w-full flex flex-row justify-between gap-[10px] items-center'>
                                                        <div className='flex flex-col'>
                                                            <h1 className='text-[16px] font-[600] text-black'>{por.name}</h1>
