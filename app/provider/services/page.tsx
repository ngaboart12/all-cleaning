  ...
  return (
    <>
      <div className='flex flex-col py-24 min-h-screen  bg-[#F8F8F8] gap-[10px] px-[10px] md:px-[50px] lg:px-[100px]'>
        <div className='flex flex-row gap-[10px] justify-between bg-white rounded-[12px] p-4 px-6 items-center'>
          <div className='flex flex-row gap-[10px] items-center'>
            ...
            <div className='p-2 bg-primary rounded-[4px]'>
              <h1 className='text-[13px] text-white'>{loadingService ? 0 : services.filter((item: any) => item.isComplete == true).length}</h1>
            </div>
          </div>
        ...
        {loadingService ? (
          <div className=' w-full grid grid-cols-1 md:grid-cols-2 ld:grid-cols-3 gap-[10px]'>
            <Skeleton height={50} className='w-full bg-white' />
            <Skeleton height={50} className='w-full bg-white' />
            <Skeleton height={50} className='w-full bg-white' />
            <Skeleton height={50} className='w-full bg-white' />
            <Skeleton height={50} className='w-full bg-white' />
            ...
            <div className=' w-full grid grid-cols-1 md:grid-cols-2 lg  :grid-cols-3 gap-[10px]'>
              {services.filter((item: any) => item.isComplete == true).map((service: any, index: number) => {
                ...
                return (
                  ...
                  <div className='flex flex-col gap-[4px] bg-white rounded-[12px] p-4 relative' key={index}>
                    <div className='flex flex-row justify-between items-center'>
                      <span className='text-[13px] font-[600]'>{service.service.title}</span>
                      <div onClick={() => handelOpenMenu(index)} className=' cursor-pointer'><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-row text-[#ABABAB] gap-[10px] items-center'>
                      ...
                      <span className='text-[14px]'>{`${month} ${day}  ${year}`}</span>
                    </div>
                    <div className='flex flex-row gap-[10px]'>
                      <div className='w-full p-4 bg-[#F8F8F8] flex flex-col rounded-[6px]'>
                        ...
                        <h1 className='font-[700]'>$ {service.estimatedPrice} <span className='text-[12px] font-[400]'>/ Hour</span></h1>
                      </div>
                      <div className='w-full p-4 bg-[#F8F8F8] flex flex-col rounded-[6px]'>
